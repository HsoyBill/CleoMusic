...
module.exports = {
  name: "volume",
  description: "Comprobar o cambiar el volumen actual",
  usage: "<volumen 0-100>",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!parseInt(args[0]))
      return client.sendTime(
        message.channel,
        `**Por favor, elija un número entre** \`1 - 100\``
      );
    ...
    options: [
      {
        ...
        type: 4,
        required: false,
        description: "Introduzca un volumen del 1 al 100. El valor predeterminado es 100.",
      },
    ],
    /**
     *
