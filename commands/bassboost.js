...
module.exports = {
  name: "bassboost",
  description: "Habilita el efecto de bassboost",
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!args[0])
      return client.sendTime(
        message.channel,
        "**Proporcione un nivel de bassboost. \nNiveles validos:** `none`, `low`, `medium`, `high`"
    ...
    return client.sendTime(
      message.channel,
      `✅ | **Nivel de bassboost establecido en** \`${level}\``
    );
  },
  SlashCommand: {
    options: [
      {
        name: "level",
        description: `Proporcione un nivel de bassboost. Niveles validos: low, medium, high, or none`,
        value: "[level]",
        type: 3,
        required: true,
      },
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      return client.sendTime(
        interaction,
        `✅ | **Establezca el nivel de bassboost en** \`${level}\``
      );
    },
  },
};
